(function(module) {
  ...
  Article.createTable = function(callback) {
    webDB.execute(
      'CREATE TABLE IF NOT EXISTS articleTable (id INTEGER PRIMARY KEY, title VARCHAR(255) NOT NULL, category VARCHAR(255), author VARCHAR(255) NOT NULL, authorUrl VARCHAR(255), publishedOn VARCHAR(100), body TEXT NOT NULL);',
      function(result) {
